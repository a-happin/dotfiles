...
type git > /dev/null 2>&1 && {
  ...
  my_install_plugin "zsh-users/zsh-autosuggestions" && {
    ...
    lazy 'ZSH_AUTOSUGGEST_MANUAL_REBIND=1; ZSH_AUTOSUGGEST_CLEAR_WIDGETS+=(history-beginning-search-forward-end history-beginning-search-backward-end); ZSH_AUTOSUGGEST_IGNORE_WIDGETS+=(__lazy_resume); lazy '\''_zsh_autosuggest_start; _zsh_autosuggest_bind_widget __zabbrev::expand-and-insert-self modify'\'
  }
}
