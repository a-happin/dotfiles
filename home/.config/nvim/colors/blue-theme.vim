...
if &background ==# 'dark'
  ...
  hi Folded ctermbg=none ctermfg=blue guibg=none guifg=#8ac6f2
  hi FoldColumn ctermbg=none ctermfg=blue guibg=none guifg=#8ac6f2
  hi SignColumn ctermbg=none ctermfg=blue guibg=none guifg=#8ac6f2
